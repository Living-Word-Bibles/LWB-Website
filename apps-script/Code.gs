 ...
 * - Adds the Trump Bible PayPal Hosted Button to paid-digital product handling.
 * - Preserves the generic Lumière browser reader; no Lumière frontend change is required.
 * v2.0.7 highlights:
